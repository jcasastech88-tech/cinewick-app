...
export default function DetailScreen({ route, navigation }) {
  ...
  const openTrailer   = () => Linking.openURL(`https://www.youtube.com/watch?v=${trailerKey}`);
...
const s = StyleSheet.create({
  ...
  playBtn:    {
    position: "absolute",
    bottom: 16, alignSelf: "center", left: width / 2 - 70,
  ...
  noTrailerBadge: {
    position: "absolute", bottom: 16, alignSelf: "center", left: width / 2 - 80,
